...
aws s3 sync mapsvg s3://www.referenda.io/mapsvg --delete --cache-control max-age=36000,public --acl public-read
...
aws s3 cp googled85d78aae9f668aa.html s3://www.referenda.io/googled85d78aae9f668aa.html --metadata-directive REPLACE --cache-control max-age=0,no-cache,no-store,must-revalidate --content-type text/html --acl public-read
